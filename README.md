...
1. Get the train annotations from [here](https://drive.google.com/file/d/1-s4QCu_v76yNwR-yXMfGqMGgHQ30WxV2/view).
...
- running on Ascend
  ...
  cd scripts/
  sh run_standalone_train.sh ../data/widerface/train

  # run distributed training example
  cd scripts/
  sh run_distribute_train.sh Ascend [DEVICE_NUM] [VISIABLE_DEVICES(0,1,2,3,4,5,6,7)] [RANK_TABLE_FILE] [DATASET_PATH]
